...
mixin _$SplashViewModel on _SplashViewModelBase, Store {
  ...
  late final _$startAnimationOnViewAsyncAction = AsyncAction(
      '_SplashViewModelBase.startAnimationOnView',
      context: context);

  @override
  Future<void> startAnimationOnView() {
    return _$startAnimationOnViewAsyncAction
        .run(() => super.startAnimationOnView());
  }
  ...
  dynamic _navigateToLogin() {
    final _$actionInfo = _$_SplashViewModelBaseActionController.startAction(
        name: '_SplashViewModelBase._navigateToLogin');
    try {
      return super._navigateToLogin();
    } finally {
      _$_SplashViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  dynamic _navigateToHome() {
    final _$actionInfo = _$_SplashViewModelBaseActionController.startAction(
        name: '_SplashViewModelBase._navigateToHome');
    try {
      return super._navigateToHome();
    } finally {
      _$_SplashViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
